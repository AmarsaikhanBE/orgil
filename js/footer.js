...
footer.innerHTML = `<div class="container"><div class="about-section"><div><div class="logo"><img src="img/md-logo.png"><h4>ОЮУН УХААНЫ ХӨГЖЛИЙН АКАДЕМИ</h4><p>Хамтын баталгаажуулалтын платформ</p></div><div class="address"><h4>УЛААНБААТАР ХОТ, СҮХБААТАР ДҮҮРЭГ, 1-Р ХОРОО, НАРНЫ ЗАМ-62, ЮНЕ СКОГИЙН ГУДАМЖ, ЮНИОН БЮЛДИНГ</h4></div></div><div style="padding-left: 3rem"><ul class="links"><li>БИДНИЙ ТУХАЙ</li><li>ЖИНХЭН ГИШҮҮД ГЭЖ ХЭН БЭ?</li><li>МАНАЙ ҮЙЛ АЖИЛЛАГАА</li><li>СУРГАЛТ</li></ul></div><div class="contact"><h4>ХОЛБОО БАРИХ</h4><p>Цахим хаяг: minddevelopment.mn<br>Цахим шуудан: info@minddevelopment.mn<br>Утас: +976 7777 3377<br>Ажилттантай холбогдох: +976 9611 8814</p></div></div><div class="footer"><p>Тооцооны загварыг хамтран бүтээсэн MEDIATOR.MN</p><p>© Зохиогчийн эрхийн хуулиар хамгаалсан. 2022 он</p></div></div>`;
